        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="flex items-center gap-3 mb-1">
               <h1 className="text-3xl font-bold text-slate-900">Edit Cut-off Entry</h1>
               <span className="bg-slate-100 text-slate-500 px-2 py-0.5 rounded text-[10px] font-bold border border-slate-200">
                  {params.id || "REC-001"}
               </span>
            </div>
            <p className="text-slate-500 font-medium text-sm">Update threshold ranks for AIIMS Delhi - MBBS (2024)</p>
          </div>
            ...
            <div className="space-y-6">
               ...
               <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="space-y-2">
                     ...
                     <select defaultValue="NEET UG" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none">
            ...
            <div className="space-y-6">
               ...
               <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  <div className="space-y-2">
                     ...
                     <select defaultValue="2024" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none">
                        <option>2024</option>
                        <option>2023</option>
                     </select>
                  </div>
                  <div className="space-y-2">
                     ...
                     <select defaultValue="Round 1" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none">
                  ...
                  <div className="space-y-2">
                     ...
                     <select defaultValue="GEN" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none">
                        <option>GEN</option>
                        <option>OBC</option>
                        <option>SC</option>
                        <option>ST</option>
                  ...
                  <div className="space-y-2">
                     ...
                     <select defaultValue="All India Quota (AIQ)" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none">
                  ...
                  <div className="space-y-4">
                     <div className="space-y-2">
                        ...
                        <div className="relative">
                           ...
                           <input type="number" defaultValue="1" className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-slate-900 outline-none focus:ring-2 focus:ring-teal-500 transition-all" />
                        </div>
                     </div>
                  </div>
                  <div className="space-y-4">
                     <div className="space-y-2">
                        ...
                        <div className="relative">
                           ...
                           <input type="number" defaultValue="50" className="w-full pl-10 pr-4 py-3 bg-teal-50 border border-teal-200 rounded-2xl text-sm font-black text-teal-900 outline-none focus:ring-2 focus:ring-teal-500 transition-all" />
                        </div>
